...
const ContactUs = () => {
  ...
  return (
    <div className='my-10'>
      <h1 className='text-[24px] font-semibold grid place-items-center my-5 '>Home  ~ Contact</h1>
      <Divider ></Divider>
      <div id="contact" className="border-[1px] border-black rounded-lg p-5 max-w-7xl mx-auto mt-8">
              ...
              >
                <div className="grid w-full border-b-2 border-black] py-5 gap-5 mx-2 grid-cols-4 ">
                  <div className="flex flex-col items-center lg:pl-0 pl-14 col-span-3">
                    ...
                    <p className="text-black font-bold">Khansama ,Dinajpur</p>
                  </div>
                </div>
                <div className="grid w-full border-b-2 border-black] py-5 gap-5 mx-2 grid-cols-4">
                  <div className="flex flex-col items-center lg:pl-0 pl-14 col-span-3">
                    <p className="text-black font-semibold">Email</p>
                    <p className="text-black font-bold ">ahs.bd@gmail.com</p>
                  </div>
                </div>
                <div className="grid w-full border-b-2 border-black] py-5 gap-5 mx-2 grid-cols-4">
                  <div className="flex flex-col items-center lg:pl-0 pl-14 col-span-3">
