...
const AcademicCalandar = () => {
    return (
        <div className='md:my-10  my-2 max-w-7xl mx-auto'>
            <h1 className='text-[15px] md:text-[24px] font-semibold grid place-items-center md:my-5 '>Home  ~ Academic  Calandar</h1>
            <Divider ></Divider>
...
export default AcademicCalandar;